...
本文一共 2万多字，分别从 Linux概述、磁盘、目录、文件、安全、语法级、实战、文件管理命令、文档编辑命令、磁盘管理命令、网络通讯命令、系统管理命令、备份压缩命令等方面拆解 `Linux` 知识点。 

本文目录：

![1623061349442](E:\other\网络\assets\1623061349442.png)

## 一、Linux 概述

![1623062254989](E:\other\网络\assets\1623062254989.png)

### 什么是Linux

`Linux`是一套免费使用和自由传播的类Unix操作系统，是一个基于`POSIX`和`Unix`的多用户、多任务、支持多线程和多`CPU`的操作系统。它能运行主要的Unix工具软件、应用程序和网络协议。它支持32位和64位硬件。`Linux`继承了`Unix`以网络为核心的设计思想，是一个性能稳定的多用户网络操作系统。

`PS`：没学过 `Linux` 可以下载这一本教程：
...
![img](https://notecdn.yiban.io/cloud_res/479621162/imgs/21-6-7_09:56:09.065_44720.png)
...
3. OS遵循命名文件中的约定，即8个字符的文件名后跟一个点，扩展名为3个字符。`BASH`没有遵循这样的惯例。
...
![1623062549754](E:\other\网络\assets\1623062549754.png)
...
![img](https://notecdn.yiban.io/cloud_res/479621162/imgs/21-6-7_09:56:08.875_42814.png)
...
![img](https://notecdn.yiban.io/cloud_res/479621162/imgs/21-6-7_09:56:08.881_73895.png)
...
![1623062599756](E:\other\网络\assets\1623062599756.png)
...
![1623062870775](E:\other\网络\assets\1623062870775.png)
...
![1623062944115](E:\other\网络\assets\1623062944115.png)
...
![1623063115259](E:\other\网络\assets\1623063115259.png)
...
![1623063358714](E:\other\网络\assets\1623063358714.png)
...
![1623063410755](E:\other\网络\assets\1623063410755.png)
...
![1623066108884](E:\other\网络\assets\1623066108884.png)
...
Linux netstat命令用于显示网络状态。利用`netstat`指令可让你得知整个Linux系统的网络情况。
...
![1623066189644](E:\other\网络\assets\1623066189644.png)
...
![1623066214212](E:\other\网络\assets\1623066214212.png)
...
本文一共有12个模块，对于工作而言，最重要的是Shell和最后面的六个模块。